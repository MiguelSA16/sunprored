    ...
    <b-container fluid class=" bg-white py-4">
        ...
        <b-modal ref="modal-editar" title="Editar Ariculo" hide-footer>
            <form action="POST" @submit.prevent="updateArticulo(fillArticulo.id)">             
                ...
                <b-form-file id="imagen" v-on:change="onImageChange" size="sm" browse-text="subir imagen" class="mb-2"></b-form-file>

                <b-col lg="6">                    
                    <b-img thumbnail fluid :src="imagen" :alt="imagen"></b-img>
                </b-col>
                <hr class="my-2">                
    ...
    export default {
        ...
        methods: {
            ...
            showModalEditar(item) {
                ...
                //this.fillArticulo.imagen = item.imagen
                this.imagen = 'http://sunpro2.test/images/articulos/'+item.imagen
            ...
            createImage(file) {
                ...
                let vm = this;
                console.log(vm)
                console.log(vm.fillArticulo.imagen)   


                reader.onload = (e) => {
                    vm.imagen = e.target.result;
                    this.fillArticulo.imagen = vm.imagen;
                };
